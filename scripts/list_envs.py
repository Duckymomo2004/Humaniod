...
All the environments are registered in the `g1_datn` extension. They start
...
with contextlib.suppress(ImportError):
    import g1_datn.tasks_experimental  # noqa: F401
...
def _format_presets(preset_map: dict | None) -> str:
    ...
    Args:
        preset_map: Mapping of :class:`~g1_datn.utils.preset_target.PresetTarget`
    ...
    if preset_map is None:
        return "(unavailable)"
    from g1_datn.utils.preset_target import PresetTarget
...
def main():
    """Print all environments registered in `g1_datn` extension."""
    ...
    if args_cli.show_presets:
        from g1_datn.utils.preset_cli import enumerate_task_presets
